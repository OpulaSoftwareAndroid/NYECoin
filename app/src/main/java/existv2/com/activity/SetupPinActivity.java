...
public class SetupPinActivity extends BaseActivity {
    ...
    private TextView tvTitle,btnForgotPin;
    ...
    private void init() {
        ...
        sharedPreference.removeValue(SetupPinActivity.this,WsConstant.SP_LOGIN_SET_PIN);
        ...
        btnForgotPin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(SetupPinActivity.this,Forgot_Pin.class);
