...
public class MainScanFingerPrintActivity extends AppCompatActivity implements FingerPrintAuthCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_scan_finger_print);
        ...
        mGoToSettingsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FingerPrintUtils.openSecuritySettings(MainScanFingerPrintActivity.this);
            }
        });
        ...
        pinEt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.toString().equals("1234")){
                    Toast.makeText(MainScanFingerPrintActivity.this, "Welcome", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(MainScanFingerPrintActivity.this, MainActivity.class));
                }
            }
    ...
    public void onAuthSuccess(FingerprintManager.CryptoObject cryptoObject) {
        Toast.makeText(MainScanFingerPrintActivity.this, "Authentication succeeded.", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(MainScanFingerPrintActivity.this, MainActivity.class));
    }
